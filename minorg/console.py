...
def filter_grna(
        ...
        pam: str = typer.Option(*params.pam(), **params.pam.options),
        ot_pattern: str = typer.Option(*params.ot_pattern(), **params.ot_pattern.options),
        ot_unaligned_as_mismatch: bool = typer.Option(*params.ot_unaligned_as_mismatch(),
                                                      **params.ot_unaligned_as_mismatch.options),
        ot_unaligned_as_gap: bool = typer.Option(*params.ot_unaligned_as_gap(),
                                                 **params.ot_unaligned_as_gap.options),
...
def app():
    ...
    if not ("sphinx" in sys.argv[0]):
        ...
        try:
            minor_g.logfile.devsplain(f"active directory: {minor_g.active_directory}")
    ...
    minor_g.cleanup()
    minor_g.logfile.devsplain("cleaning up")
